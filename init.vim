...
inoremap <silent><expr> <leader>tt neosnippet#expand('tt')
inoremap <silent><expr> <leader>tf neosnippet#expand('tf')
inoremap <silent><expr> <leader>tc neosnippet#expand('tc')
inoremap <silent><expr> <leader>ti neosnippet#expand('ti')
inoremap <silent><expr> <leader>tg neosnippet#expand('tg')
inoremap <silent><expr> <leader>ts neosnippet#expand('ts')
